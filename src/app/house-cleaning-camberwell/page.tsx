...
export const metadata = {
  title: "House Cleaning Camberwell | Same Cleaner Every Visit | Crisp Cleaning",
  description: "Professional house cleaning in Camberwell. Heritage homes near Camberwell Junction and the Sunday market. Fixed pricing, same cleaner every visit. Book instantly.",
  alternates: {
    canonical: "/house-cleaning-camberwell/",
  },
};

const faqs = [
  { question: "Do you service Camberwell?", answer: "Yes, we provide professional house cleaning services throughout Camberwell and surrounding areas. Your quote is calculated instantly based on your home size." },
  { question: "How much does house cleaning cost in Camberwell?", answer: "Pricing is fixed and transparent, based on your home's actual room count and scope, not hourly estimates. Get an exact price in under 60 seconds online." },
  ...
  { question: "Do I need to be home during the clean?", answer: "No. Most of our clients in Camberwell provide a keybox code, leave keys with concierge, or let our cleaners in before heading out for the day." },
...
export default async function SuburbTemplatePage() {
  const SUBURB_NAME = "Camberwell"; // Change this variable when cloning the page for a new city
  ...
  return (
    <main className="min-h-screen bg-background selection:bg-primary/20 selection:text-primary overflow-x-hidden font-sans">
              ...
              },
              {
                ...
                "itemListElement": [
                  ...
                  },
                  {
                    "@type": "ListItem",
                    "position": 2,
                    "name": "House Cleaning Camberwell",
                    "item": "https://crispcleaning.com.au/house-cleaning-camberwell/"
                  }
                ]
              }
            ]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start order-2 lg:order-1">
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-gray-200 shadow-sm mb-6">
                ...
                <span className="text-[13px] font-semibold text-gray-700 tracking-wide uppercase">House Cleaning in Camberwell</span>
              </div>

              <h1 className="text-4xl md:text-5xl lg:text-[56px] font-display font-bold leading-[1.1] text-gray-900 mb-6 tracking-tight">
                House cleaning in <span className="text-[#FB8C42]">Camberwell</span>
              </h1>
      ...
      <QuoteRequestPanel
        headline={
          <>
            Get your <span className="text-[#FB8C42]">Camberwell</span> price in seconds
          </>
        }
        subheadline="Transparent pricing. No hidden fees. Book online immediately."
        seoKeyword="house cleaning camberwell"
      />
      ...
      <section className="pt-8 pb-12 md:pt-10 md:pb-16 relative bg-white border-b border-gray-100">
        <div className="container mx-auto px-6 max-w-[800px] text-center">
          ...
          <div className="text-[16px] md:text-[18px] text-gray-500 font-normal leading-[28px] mx-auto text-left md:text-center">
            <p className="mb-6">
              Camberwell Junction is one of Melbourne's busiest inner suburban retail centres, and the streets around it are among the most tightly held in the City of Boroondara — heritage homes on tree lined streets with long tenure families and a community character centred around the well known Sunday market on Station Street.
            </p>
            <p>
              Our fixed, scope based pricing handles Camberwell's typically generous heritage properties accurately, and the same cleaner is assigned from your first booking so the home's specific details are never explained again. An instant quote based on your actual room count, bookable in under a minute.
            </p>
          </div>
      ...
      {/* 3. Why Crisp is Camberwell's Preferred Cleaning Service */}
        ...
        <div className="container mx-auto px-6 md:px-8 max-w-[1200px]">
          <div className="text-center mb-8 md:mb-20">
            ...
            <h2 className="text-4xl md:text-[42px] font-bold text-gray-900 tracking-tight mb-6">
              Why Crisp is <span className="text-[#FB8C42]">Camberwell's</span> Preferred Cleaning Service
            </h2>
          </div>
          ...
          <div className="bg-[#FAF9F6] p-8 md:p-12 rounded-[32px] shadow-sm border border-gray-100 relative overflow-hidden flex flex-col md:flex-row items-center gap-8 md:gap-12">
            <div className="flex-1 text-center md:text-left">
              ...
              <h2 className="text-3xl md:text-[36px] font-bold text-gray-900 tracking-tight mb-4">
                <span className="text-[#FB8C42]">Camberwell</span> Cleaning Prices
              </h2>
      ...
      {/* 5. What Camberwell Homeowners Say */}
      <Testimonials
        title={<>What <span className="text-[#FB8C42]">Camberwell</span> Homeowners Say</>}
      ...
      <section className="py-12 md:py-24 bg-white border-t border-gray-100">
        <div className="container mx-auto px-6 md:px-8 max-w-[900px] text-center">
          ...
          <p className="text-[15px] md:text-[16px] text-gray-500 mb-10 max-w-2xl mx-auto leading-relaxed">
            Not in Camberwell? We cover a wide range of surrounding suburbs across Melbourne.
          </p>
          <div className="flex flex-wrap justify-center gap-3 md:gap-4">
            {/* These will be replaced per suburb */}
            {['Kew', 'Hawthorn', 'Glen Iris', 'Malvern', 'Balwyn North'].map((area, idx) => (
              <span
                key={idx}
      ...
      {/* 7. Book a Cleaner in Camberwell */}
      <FinalCTA
        title={<>Book a Cleaner in <span className="text-primary">Camberwell</span></>}
        description="Crisp has limited weekly slots in Camberwell — secure your dedicated cleaner today."
      />
