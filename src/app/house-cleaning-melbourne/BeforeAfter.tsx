...
function ComparisonCard({ beforeImage, afterImage, label }: ComparisonCardProps) {
  ...
  const comparisons = [
    {
      beforeImage: "/images/dirty-bathroom-before-service.webp",
      afterImage: "/images/clean-bathroom-after-service.webp",
      label: "BATHROOM SINK · BEFORE/AFTER"
    },
    {
      beforeImage: "/images/gas-stove-before-cleaning-melbourne.webp",
      afterImage: "/images/gas-stove-after-cleaning-melbourne.webp",
      label: "GAS STOVE · BEFORE/AFTER"
    },
    {
      beforeImage: "/images/fridge-before-cleaning-melbourne.webp",
      afterImage: "/images/fridge-after-cleaning-melbourne.webp",
    ...
    <section className="py-24 md:py-32 bg-[#FDFBF9] relative">
      <div className="container mx-auto px-6 md:px-8 max-w-[1216px]">
        ...
        <div className="mb-16 md:mb-20 max-w-[896px]">
          ...
          >
            Real results from Melbourne homes.
          </h2>
