...
const vacateCleaningData = {
  ...
  whatsIncluded: {
    targetKeyword: "vacate cleaning melbourne",
    headline: <>What's Included in Our <span className="text-primary">Vacate Cleaning</span>?</>,
    seoParagraph: (
      <>
        Our end of lease cleaning service is designed to help tenants leave their rental property in excellent condition and prepare it for final inspection. Also known as vacate cleaning or move-out cleaning, this service focuses on restoring the property to a clean, presentable state that meets typical real estate standards. Our experienced cleaners follow a detailed checklist covering all rooms, including kitchens, bathrooms, living areas, and bedrooms. From deep surface cleaning to thorough floor and bathroom sanitisation, we aim to ensure the property looks spotless for inspection. The tasks below outline what is typically included in our end of lease cleaning service.
      </>
    ),
    items: [
      ...
      "Wall marks and skirting board cleaning",
      "Carpet vacuuming and floor mopping",
      "Complete property deep clean for inspection"
    ],
  ...
  return (
    <main className="min-h-screen bg-background selection:bg-primary/20 selection:text-primary overflow-x-hidden font-sans">
      ...
      <CTASection
        ...
        description="Moving out? Ensure you get your bond back with our comprehensive vacate cleaning service. Book today for a stress-free move."
        primaryAction={{
          text: "Book Now",
          href: "/booking",
        }}
