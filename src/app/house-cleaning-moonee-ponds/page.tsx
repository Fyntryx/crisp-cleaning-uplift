...
export const metadata = {
  title: "House Cleaning Moonee Ponds | Fixed Pricing, Same Cleaner | Crisp Cleaning",
  description: "Professional house cleaning in Moonee Ponds. Family homes near Puckle Street and Queens Park. Fixed pricing, same cleaner every visit. Book instantly online.",
  alternates: {
    canonical: "/house-cleaning-moonee-ponds/",
  },
};

const faqs = [
  { question: "Do you service Moonee Ponds?", answer: "Yes, we provide professional house cleaning services throughout Moonee Ponds and surrounding areas. Your quote is calculated instantly based on your home size." },
  { question: "How much does house cleaning cost in Moonee Ponds?", answer: "Pricing is fixed and transparent, based on your home's actual room count and scope, not hourly estimates. Get an exact price in under 60 seconds online." },
  ...
  { question: "Do I need to be home during the clean?", answer: "No. Most of our clients in Moonee Ponds provide a keybox code, leave keys with concierge, or let our cleaners in before heading out for the day." },
...
export default async function SuburbTemplatePage() {
  const SUBURB_NAME = "Moonee Ponds";
  ...
  return (
    <main className="min-h-screen bg-background selection:bg-primary/20 selection:text-primary overflow-x-hidden font-sans">
              ...
              },
              {
                ...
                "itemListElement": [
                  ...
                  },
                  {
                    "@type": "ListItem",
                    "position": 2,
                    "name": "House Cleaning Moonee Ponds",
                    "item": "https://crispcleaning.com.au/house-cleaning-moonee-ponds/"
                  }
                ]
              }
            ]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start order-2 lg:order-1">
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-gray-200 shadow-sm mb-6">
                ...
                <span className="text-[13px] font-semibold text-gray-700 tracking-wide uppercase">House Cleaning in Moonee Ponds</span>
              </div>

              <h1 className="text-4xl md:text-5xl lg:text-[56px] font-display font-bold leading-[1.1] text-gray-900 mb-6 tracking-tight">
                House cleaning in <span className="text-[#FB8C42]">Moonee Ponds</span>
              </h1>
      ...
      <QuoteRequestPanel
        headline={
          <>
            Get your <span className="text-[#FB8C42]">Moonee Ponds</span> price in seconds
          </>
        }
        subheadline="Transparent pricing. No hidden fees. Book online immediately."
        seoKeyword="house cleaning moonee ponds"
      />
      ...
      <section className="pt-8 pb-12 md:pt-10 md:pb-16 relative bg-white border-b border-gray-100">
        <div className="container mx-auto px-6 max-w-[800px] text-center">
          ...
          <div className="text-[16px] md:text-[18px] text-gray-500 font-normal leading-[28px] mx-auto text-left md:text-center">
            <p className="mb-6">
              Moonee Ponds is anchored by the Puckle Street shopping precinct and bordered by the gracious Queens Park — a suburb whose inner west prestige feels earned rather than marketed. The housing is genuinely mixed: Edwardian and Californian bungalow stock from the suburb's early development alongside mid century homes and newer townhouse infill.
            </p>
            <p>
              With 360 annual searches, this is the highest-volume Tier B page in the inner western cluster and warrants proportionally greater care in the build and internal linking. Crisp services the full suburb from Puckle Street through to the Essendon and Ascot Vale borders, with fixed pricing by your home's actual scope and the same cleaner assigned from the very first booking.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-8 max-w-[1200px]">
          <div className="text-center mb-8 md:mb-20">
            ...
            <h2 className="text-4xl md:text-[42px] font-bold text-gray-900 tracking-tight mb-6">
              Why Crisp is <span className="text-[#FB8C42]">Moonee Ponds's</span> Preferred Cleaning Service
            </h2>
          </div>
          ...
          <div className="bg-[#FAF9F6] p-8 md:p-12 rounded-[32px] shadow-sm border border-gray-100 relative overflow-hidden flex flex-col md:flex-row items-center gap-8 md:gap-12">
            <div className="flex-1 text-center md:text-left">
              ...
              <h2 className="text-3xl md:text-[36px] font-bold text-gray-900 tracking-tight mb-4">
                <span className="text-[#FB8C42]">Moonee Ponds</span> Cleaning Prices
              </h2>
      ...
      <Testimonials googleRatingValue={googleRatingValue} googleReviewCount={googleReviewCount}
        title={<>What <span className="text-[#FB8C42]">Moonee Ponds</span> Homeowners Say</>}
      ...
      <section className="py-12 md:py-24 bg-white border-t border-gray-100">
        <div className="container mx-auto px-6 md:px-8 max-w-[900px] text-center">
          ...
          <p className="text-[15px] md:text-[16px] text-gray-500 mb-10 max-w-2xl mx-auto leading-relaxed">
            Not in Moonee Ponds? We cover a wide range of surrounding suburbs across Melbourne.
          </p>
          <div className="flex flex-wrap justify-center gap-3 md:gap-4">
            {/* These will be replaced per suburb */}
            {['Essendon', 'Maribyrnong', 'Strathmore', 'Ascot Vale', 'Brunswick'].map((area, idx) => (
              <span
                key={idx}
      ...
      <FinalCTA
        title={<>Book a Cleaner in <span className="text-primary">Moonee Ponds</span></>}
        description="Crisp has limited weekly slots in Moonee Ponds — secure your dedicated cleaner today."
      />
