...
export const metadata = {
  ...
  description: "Professional house cleaning in Glen Waverley. Family homes near The Glen and Glen Waverley Secondary. Fixed pricing, same cleaner every visit. Instant quote online.",
  alternates: {
    canonical: "/house-cleaning-glen-waverley/",
  },
};

const faqs = [
  { question: "Do you service Glen Waverley?", answer: "Yes, we provide professional house cleaning services throughout Glen Waverley and surrounding areas. Your quote is calculated instantly based on your home size." },
  { question: "How much does house cleaning cost in Glen Waverley?", answer: "Pricing is fixed and transparent, based on your home's actual room count and scope, not hourly estimates. Get an exact price in under 60 seconds online." },
  ...
  { question: "Do I need to be home during the clean?", answer: "No. Most of our clients in Glen Waverley provide a keybox code, leave keys with concierge, or let our cleaners in before heading out for the day." },
...
export default async function SuburbTemplatePage() {
  const SUBURB_NAME = "Glen Waverley"; // Change this variable when cloning the page for a new city
  ...
  return (
    <main className="min-h-screen bg-background selection:bg-primary/20 selection:text-primary overflow-x-hidden font-sans">
              ...
              },
              {
                ...
                "itemListElement": [
                  ...
                  },
                  {
                    "@type": "ListItem",
                    "position": 2,
                    "name": "House Cleaning Glen Waverley",
                    "item": "https://crispcleaning.com.au/house-cleaning-glen-waverley/"
                  }
                ]
              }
            ]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start order-2 lg:order-1">
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-gray-200 shadow-sm mb-6">
                ...
                <span className="text-[13px] font-semibold text-gray-700 tracking-wide uppercase">House Cleaning in Glen Waverley</span>
              </div>

              <h1 className="text-4xl md:text-5xl lg:text-[56px] font-display font-bold leading-[1.1] text-gray-900 mb-6 tracking-tight">
                House cleaning in <span className="text-[#FB8C42]">Glen Waverley</span>
              </h1>
      ...
      <QuoteRequestPanel
        headline={
          <>
            Get your <span className="text-[#FB8C42]">Glen Waverley</span> price in seconds
          </>
        }
        subheadline="Transparent pricing. No hidden fees. Book online immediately."
        seoKeyword="house cleaning glen-waverley"
      />
      ...
      <section className="pt-8 pb-12 md:pt-10 md:pb-16 relative bg-white border-b border-gray-100">
        <div className="container mx-auto px-6 max-w-[800px] text-center">
          ...
          <div className="text-[16px] md:text-[18px] text-gray-500 font-normal leading-[28px] mx-auto text-left md:text-center">
            <p className="mb-6">
              Glen Waverley is commercially anchored by The Glen shopping centre on Springvale Road and carries one of Melbourne's most sought after school catchments — Glen Waverley Secondary College draws families from across the eastern suburbs specifically to this postcode. The suburb has a well established Chinese Australian community that has shaped its dining precincts and community character over several decades, giving it a distinct identity within the south east middle ring.
            </p>
            <p>
              Our fixed pricing handles Glen Waverley's typically substantial family homes — many with multiple living areas — accurately by room count, with the same cleaner assigned from your very first booking.
            </p>
          </div>
      ...
      {/* 3. Why Crisp is Glen Waverley's Preferred Cleaning Service */}
        ...
        <div className="container mx-auto px-6 md:px-8 max-w-[1200px]">
          <div className="text-center mb-8 md:mb-20">
            ...
            <h2 className="text-4xl md:text-[42px] font-bold text-gray-900 tracking-tight mb-6">
              Why Crisp is <span className="text-[#FB8C42]">Glen Waverley's</span> Preferred Cleaning Service
            </h2>
          </div>
      ...
      {/* 4. Glen Waverley Cleaning Prices */}
          ...
          <div className="bg-[#FAF9F6] p-8 md:p-12 rounded-[32px] shadow-sm border border-gray-100 relative overflow-hidden flex flex-col md:flex-row items-center gap-8 md:gap-12">
            <div className="flex-1 text-center md:text-left">
              ...
              <h2 className="text-3xl md:text-[36px] font-bold text-gray-900 tracking-tight mb-4">
                <span className="text-[#FB8C42]">Glen Waverley</span> Cleaning Prices
              </h2>
      ...
      {/* 5. What Glen Waverley Homeowners Say */}
      <Testimonials googleRatingValue={googleRatingValue} googleReviewCount={googleReviewCount}
        title={<>What <span className="text-[#FB8C42]">Glen Waverley</span> Homeowners Say</>}
      ...
      <section className="py-12 md:py-24 bg-white border-t border-gray-100">
        <div className="container mx-auto px-6 md:px-8 max-w-[900px] text-center">
          ...
          <p className="text-[15px] md:text-[16px] text-gray-500 mb-10 max-w-2xl mx-auto leading-relaxed">
            Not in Glen Waverley? We cover a wide range of surrounding suburbs across Melbourne.
          </p>
          <div className="flex flex-wrap justify-center gap-3 md:gap-4">
            {/* These will be replaced per suburb */}
            {['Mount Waverley', 'Doncaster East', 'Ringwood', 'Oakleigh', 'Wheelers Hill'].map((area, idx) => (
              <span
                key={idx}
      ...
      {/* 7. Book a Cleaner in Glen Waverley */}
      <FinalCTA
        title={<>Book a Cleaner in <span className="text-primary">Glen Waverley</span></>}
        description="Crisp has limited weekly slots in Glen Waverley — secure your dedicated cleaner today."
      />
