  ...
  return (
    <main className="min-h-screen bg-background selection:bg-primary/20 selection:text-primary overflow-x-hidden font-sans">
      ...
      <section className="py-24 bg-background relative overflow-hidden">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="text-center">
            <Link href="/booking">
              <Button size="lg" className="rounded-full px-10 h-14 text-lg font-semibold shadow-lg shadow-primary/20">
                {whatsIncluded.cta}
              </Button>
            </Link>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto bg-primary text-primary-foreground rounded-[2rem] p-10 md:p-16 relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 text-center">
              ...
              <Link href="/booking">
                <Button size="xl" variant="secondary" className="rounded-full text-lg px-10 h-14 text-primary font-bold shadow-xl hover:shadow-2xl transition-all">
      ...
      <CTASection
        ...
        description="Live in a pristine apartment without the effort. Book our specialized apartment cleaning service today for a spotless living space."
        primaryAction={{
          text: "Book Now",
          href: "/booking",
        }}
