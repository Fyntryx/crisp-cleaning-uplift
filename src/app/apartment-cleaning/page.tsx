...
const apartmentCleaningData = {
  ...
  whatsIncluded: {
    targetKeyword: "apartment cleaning melbourne",
    headline: <>What's Included in Our <span className="text-primary">Apartment Cleaning</span>?</>,
    seoParagraph: (
      <>
        Our apartment cleaning service is tailored specifically for apartments and smaller residential spaces. Whether you live in a studio apartment, a one-bedroom unit, or a larger apartment, our professional cleaners focus on keeping your living environment clean, hygienic, and well maintained. Our team carefully cleans kitchens, bathrooms, living areas, and bedrooms while paying close attention to high-touch surfaces and commonly used spaces. This service is ideal for residents looking for regular apartment cleaning, one-off cleaning, or ongoing maintenance cleaning. The checklist below outlines the tasks typically included in our professional apartment cleaning service.
      </>
    ),
    items: [
      "Kitchen cleaning",
...
export default function ApartmentCleaningPage() {
  const { hero, trustBar, whatsIncluded, features, pricingExplanation, finalCta, faqs } = apartmentCleaningData;
    ...
    <main className="min-h-screen bg-background selection:bg-primary/20 selection:text-primary overflow-x-hidden font-sans">
            ...
            "@graph": [
              {
                ...
                "description": "Professional apartment cleaning service in Melbourne.",
              ...
              { "@type": "Service", "serviceType": "Apartment Cleaning", "provider": { "@id": "https://crisp-cleaning-app-seven.vercel.app/#localbusiness" } },
      ...
      <div className="pt-24 lg:pt-32">
        <QuoteRequestPanel
          ...
          contextPoints={["Top-rated apartment cleaning professionals in Melbourne.", "Flexible scheduling to fit your needs.", "100% Satisfaction Guarantee."]}
        />
      </div>
