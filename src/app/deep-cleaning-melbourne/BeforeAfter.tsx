...
function ComparisonCard({ beforeImage, afterImage, label }: ComparisonCardProps) {
  ...
  const comparisons = [
    {
      beforeImage: "/images/couch-before-cleaning-melbourne.webp",
      afterImage: "/images/couch-after-cleaning-melbourne.webp",
      label: "SOFA · BEFORE/AFTER"
    },
    {
      beforeImage: "/images/window-before-cleaning-melbourne.webp",
      afterImage: "/images/window-after-cleaning-melbourne.webp",
      label: "WINDOW · BEFORE/AFTER"
    },
    {
      beforeImage: "/images/chimney-before-cleaning-melbourne.webp",
      afterImage: "/images/chimney-after-cleaning-melbourne.webp",
