...
export const metadata = {
  title: "House Cleaning Croydon | Same Cleaner Every Visit | Crisp Cleaning",
  description: "Professional house cleaning in Croydon. Family suburban homes near Croydon Central. Fixed scope pricing, same cleaner every visit. Book online instantly.",
  alternates: {
    canonical: "/house-cleaning-croydon/",
  },
};

const faqs = [
  { question: "Do you service Croydon?", answer: "Yes, we provide professional house cleaning services throughout Croydon and surrounding areas. Your quote is calculated instantly based on your home size." },
  { question: "How much does house cleaning cost in Croydon?", answer: "Pricing is fixed and transparent, based on your home's actual room count and scope, not hourly estimates. Get an exact price in under 60 seconds online." },
  ...
  { question: "Do I need to be home during the clean?", answer: "No. Most of our clients in Croydon provide a keybox code, leave keys with concierge, or let our cleaners in before heading out for the day." },
  ...
  return (
    <main className="min-h-screen bg-background selection:bg-primary/20 selection:text-primary overflow-x-hidden font-sans">
              ...
              },
              {
                ...
                "itemListElement": [
                  ...
                  },
                  {
                    "@type": "ListItem",
                    "position": 2,
                    "name": "House Cleaning Croydon",
                    "item": "https://crispcleaning.com.au/house-cleaning-croydon/"
                  }
                ]
              }
            ]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start order-2 lg:order-1">
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-gray-200 shadow-sm mb-6">
                ...
                <span className="text-[13px] font-semibold text-gray-700 tracking-wide uppercase">House Cleaning in Croydon</span>
              </div>

              <h1 className="text-4xl md:text-5xl lg:text-[56px] font-display font-bold leading-[1.1] text-gray-900 mb-6 tracking-tight">
                House cleaning in <span className="text-[#FB8C42]">Croydon</span>
              </h1>
      ...
      <QuoteRequestPanel
        headline={
          <>
            Get your <span className="text-[#FB8C42]">Croydon</span> price in seconds
          </>
        }
        subheadline="Transparent pricing. No hidden fees. Book online immediately."
        seoKeyword="house cleaning croydon"
      />
      ...
      <section className="pt-8 pb-12 md:pt-10 md:pb-16 relative bg-white border-b border-gray-100">
        <div className="container mx-auto px-6 max-w-[800px] text-center">
          ...
          <div className="text-[16px] md:text-[18px] text-gray-500 font-normal leading-[28px] mx-auto text-left md:text-center">
            <p className="mb-6">
              Croydon's shopping precincts — Croydon Central on Mt Dandenong Road and Eastfield Mall nearby — anchor a suburb that is resolutely family oriented, with 1970s to 80s brick homes on practical suburban blocks making up the dominant housing profile. At 530 annual searches, Croydon holds the single highest search volume in the entire Tier B group and justifies a slightly more thorough build investment despite the high competition score.
            </p>
            <p>
              A strongly localised, differentiated page here offers genuine first mover potential over competitors using generic eastern suburbs template copy. Crisp services Croydon with fixed scope pricing and the same cleaner every visit.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-8 max-w-[1200px]">
          <div className="text-center mb-8 md:mb-20">
            ...
            <h2 className="text-4xl md:text-[42px] font-bold text-gray-900 tracking-tight mb-6">
              Why Crisp is <span className="text-[#FB8C42]">Croydon's</span> Preferred Cleaning Service
            </h2>
          </div>
          ...
          <div className="bg-[#FAF9F6] p-8 md:p-12 rounded-[32px] shadow-sm border border-gray-100 relative overflow-hidden flex flex-col md:flex-row items-center gap-8 md:gap-12">
            <div className="flex-1 text-center md:text-left">
              ...
              <h2 className="text-3xl md:text-[36px] font-bold text-gray-900 tracking-tight mb-4">
                <span className="text-[#FB8C42]">Croydon</span> Cleaning Prices
              </h2>
      ...
      <section className="py-12 md:py-24 bg-white border-t border-gray-100">
        <div className="container mx-auto px-6 md:px-8 max-w-[900px] text-center">
          ...
          <p className="text-[15px] md:text-[16px] text-gray-500 mb-10 max-w-2xl mx-auto leading-relaxed">
            Not in Croydon? We cover a wide range of surrounding suburbs across Melbourne.
          </p>
          <div className="flex flex-wrap justify-center gap-3 md:gap-4">
            {/* These will be replaced per suburb */}
            {['Ringwood', 'Doncaster East', 'Mitcham', 'Bayswater'].map((area, idx) => (
              <span
                key={idx}
      ...
      <FinalCTA
        title={<>Book a Cleaner in <span className="text-primary">Croydon</span></>}
        description="Crisp has limited weekly slots in Croydon — secure your dedicated cleaner today."
      />
