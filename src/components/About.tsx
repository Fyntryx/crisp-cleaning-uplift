        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-display font-bold mb-6">
              Get To Know <span className="text-gradient">Our Story</span>
            </h2>
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              Curious about the heart behind our pristine services? Dive into
              the essence of Crisp Cleaning by exploring our story. Discover the
              passion, values, and commitment that drive us to elevate the
              standards of cleanliness.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-8">
              We believe that a clean space is more than just visually
