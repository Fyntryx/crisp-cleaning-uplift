    ...
    <div className="min-h-[100dvh] flex flex-col bg-white font-sans text-gray-900 pb-[calc(5*var(--scale-unit))] min-[880px]:pb-0">
      <div className="w-full flex-1 flex flex-col">
        ...
        <div className="flex flex-col min-[880px]:flex-row items-stretch w-full flex-1">
          ...
          <div className="hidden min-[1180px]:block w-[calc(13.5*var(--scale-unit))] shrink-0 bg-transparent border-r border-[#e5e5e5]">
          ...
          <div className="hidden min-[880px]:block w-[calc(18.5*var(--scale-unit))] shrink-0 bg-[#fdf9f3] border-l border-[#e5e5e5]">
