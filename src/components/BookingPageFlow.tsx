...
const Services = ({ hiddenInline = false }: { hiddenInline?: boolean }) => {
  ...
  const transformResidentialFormDataToAPI = () => {
    ...
    return {
      ...
      hourlyHours: formData.cleaningType === 'Hourly' ? (formData.hourlyDetails?.hours || 2) : undefined,
      hourlyCleaners: formData.cleaningType === 'Hourly' ? (formData.hourlyDetails?.cleaners || 1) : undefined,
  ...
  const renderStep1 = () => {
    ...
    return (
      <div className="max-w-4xl mx-auto w-full flex flex-col py-2">
        <div className="max-w-4xl mx-auto w-full flex flex-col gap-[calc(1.5*var(--scale-unit))]">
          <div className="mb-2">
