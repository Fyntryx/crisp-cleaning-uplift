        ...
        {step1Types.map((type) => {
          ...
          return (
            <div
              ...
              className={`group bg-white border md:border-2 rounded-[24px] p-5 md:p-6 cursor-pointer transition-all duration-300 relative overflow-visible flex flex-col items-start min-h-[155px] md:min-h-[200px] ${isSelected
