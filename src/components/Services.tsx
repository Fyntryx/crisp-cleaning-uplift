        ...
        {step1Types.map((type) => {
          ...
          return (
            <div
              ...
              className={`group bg-white border-2 rounded-[24px] p-6 cursor-pointer transition-all duration-300 relative overflow-visible flex flex-col items-start min-h-[auto] md:min-h-[200px] ${isSelected
