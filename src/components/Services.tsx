        ...
        {step1Types.map((type) => {
          ...
          return (
            <div
              ...
              className={`group bg-white border md:border-2 rounded-[24px] p-4 md:p-6 cursor-pointer transition-all duration-300 relative overflow-visible flex flex-col items-start min-h-[140px] md:min-h-[200px] ${isSelected
