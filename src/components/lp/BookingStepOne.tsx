          ...
          {plans.map(plan => {
            ...
            return (
              <button
                ...
                className={`relative p-5 md:p-6 rounded-2xl border md:border-2 min-h-[175px] md:min-h-auto transition-all duration-300 flex flex-col items-start text-left group ${
                  isSelected 
