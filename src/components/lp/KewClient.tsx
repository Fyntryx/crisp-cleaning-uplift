...
const faqData = [
  ...
  },
  {
    ...
    answer: "Yes - our Kew coverage includes East Kew and Kew West, as well as the full Sydney Road corridor from North Melbourne through to the Coburg boundary."
  },
  {
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-[48px]">
            <div className="text-[12px] text-[#9ca3af]">
              <Breadcrumbs 
                items={[
                  { label: "Home", href: "/" },
                  { label: "House Cleaning Kew", href: "/house-cleaning-brunswick" },
                ]}
              />
            </div>
