          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            ...
            <ScrollReveal delay={0.1}>
              <div className="bg-[#ffffff] border border-[#e5e7eb] rounded-[24px] p-8 shadow-sm">
                <p className="text-justify text-[12px] font-[900] uppercase tracking-[0.15em] text-[#374151] mb-3">Standard</p>
            ...
            <ScrollReveal delay={0.2} className="relative z-10">
              <div className="bg-[#0f172a] rounded-[24px] p-8 shadow-[0_20px_40px_rgba(0,0,0,0.15)] scale-100 md:scale-[1.04] border border-[rgba(255,255,255,0.1)]">
                ...
                <p className="text-justify text-[12px] font-[900] uppercase tracking-[0.15em] text-[rgba(255,255,255,0.7)] mb-3">Deep</p>
            ...
            <ScrollReveal delay={0.3}>
              <div className="bg-[#ffffff] border border-[#e5e7eb] rounded-[24px] p-8 shadow-sm">
                <p className="text-justify text-[12px] font-[900] uppercase tracking-[0.15em] text-[#374151] mb-3">Vacate</p>
                <div className="mb-6 pb-6 border-b border-[#f3f4f6]">
