...
const faqData = [
  {
    question: "Do you clean share houses and rental properties in Armadale?",
    answer: "Yes - share houses and rentals are central to Armadale's residential profile. Fixed pricing per property, same cleaner, and property manager or landlord bookings all welcome."
  },
  {
    question: "How much does house cleaning cost in Armadale?",
  ...
  {
    question: "Do you service East Armadale and Armadale West as well?",
    answer: "Yes - our Armadale coverage includes East Armadale and Armadale West, as well as the full Sydney Road corridor from North Melbourne through to the Coburg boundary."
  },
  {
...
export default function ArmadaleClient() {
  return (
    <>
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-[48px]">
            <div className="text-[12px] text-[#9ca3af]">
              <Breadcrumbs 
                items={[
                  { label: "Home", href: "/" },
                  { label: "House Cleaning Armadale", href: "/house-cleaning-brunswick" },
                ]}
              />
            </div>
            <div className="inline-block bg-[rgba(193,123,62,0.12)] border border-[rgba(193,123,62,0.3)] text-[#C17B3E] text-[11px] font-[600] tracking-[0.12em] uppercase rounded-[99px] px-[16px] py-[6px]">
              ● Sydney Road · Armadale · Inner North
            </div>
          </div>
        ...
        <div className="max-w-[1100px] mx-auto px-[24px] md:px-[48px] grid grid-cols-1 md:grid-cols-[1fr_1.4fr] gap-[48px] md:gap-[80px] items-start">
          ...
          <div className="md:sticky md:top-[40px]">
            ...
            <h2 className="text-[32px] md:text-[36px] font-[700] text-[#1C1C1C] leading-[1.1]">
              What's Included in Every Armadale Clean
            </h2>
            <p className="text-[15px] text-[#6b7280] leading-[1.8] mt-[16px]">
              Every Armadale clean covers the same documented scope regardless of property type - kitchen, all bathrooms, floors throughout, bedrooms, and living areas. Room count determines the price. The scope is agreed before the cleaner arrives so there's no ambiguity about what's included on the day.
            </p>
          ...
          <div className="flex flex-col">
            ...
            <div className="py-[28px] border-b border-[#E0D8CC] first:pt-0">
              ...
              <p className="text-[14px] text-[#6b7280] leading-[1.75]">
                Kitchen surfaces, stovetop, rangehood, splashback, sink, and accessible appliance exteriors are cleaned to a hygienic standard on every visit. Armadale's terrace kitchens are often compact and high-traffic - particularly in share houses - and accumulate cooking residue faster than a single-occupant kitchen. The same thorough scope applies regardless of occupancy volume or kitchen size.
              </p>
            ...
            <div className="py-[28px]">
              ...
              <p className="text-[14px] text-[#6b7280] leading-[1.75]">
                Every bedroom in scope is vacuumed or mopped, surfaces dusted, and the room left to a presented standard. Living and dining areas receive the same treatment. For Armadale's terrace properties with an open living arrangement extending through to a rear addition, the scope covers the full connected space within the confirmed room count.
              </p>
              <div className="mt-[14px] flex flex-wrap gap-[6px]">
        ...
        <div className="max-w-[1100px] mx-auto px-[24px] md:px-[48px]">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[12px]">
            ...
            <div className="bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.08)] border-t-[3px] border-t-[#C17B3E] rounded-[16px] p-[28px_24px] hover:bg-[rgba(255,255,255,0.07)] transition-colors duration-200">
              ...
              <p className="text-[13px] text-[rgba(255,255,255,0.5)] leading-[1.6]">
                Whether it's a single-fronted terrace on one of Armadale's classic residential streets or a two-bedroom apartment near Anstey station, pricing is confirmed online before any cleaner arrives. No hourly rate that overruns, no ambiguity about which rooms are and aren't included.
              </p>
            </div>
            ...
            <div className="bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.08)] border-t-[3px] border-t-[rgba(255,255,255,0.2)] rounded-[16px] p-[28px_24px] hover:bg-[rgba(255,255,255,0.07)] transition-colors duration-200">
              ...
              <p className="text-[13px] text-[rgba(255,255,255,0.5)] leading-[1.6]">
                Armadale is a high-rental suburb - landlords, property managers, and joint tenant-landlord arrangements are all common. Crisp handles bookings from all configurations; scheduling, invoicing, and access arrangements can be managed from a single account regardless of who holds the tenancy.
              </p>
            </div>
            ...
            <div className="bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.08)] border-t-[3px] border-t-[#d97706] rounded-[16px] p-[28px_24px] hover:bg-[rgba(255,255,255,0.07)] transition-colors duration-200">
              ...
              <p className="text-[13px] text-[rgba(255,255,255,0.5)] leading-[1.6]">
                Get an exact price based on your Armadale property's room count and service type in under 60 seconds. No call-back, no site inspection, no three-day wait for a quote email. The price confirmed in your instant quote is the price in your booking confirmation. 15% off the first clean.
              </p>
            </div>
        ...
        <div className="max-w-[1100px] mx-auto px-[24px] md:px-[48px] mt-[48px]">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[16px]">
            ...
            <div className="bg-[#ffffff] border border-[#E0D8CC] border-l-[4px] border-l-[#C17B3E] rounded-[16px] p-[28px]">
              ...
              <div className="text-[12px] text-[#6b7280]">Armadale</div>
            </div>
      ...
      <section className="bg-[#ffffff] py-[80px]">
        <div className="max-w-[1100px] mx-auto px-[24px] md:px-[48px] text-center mb-[48px]">
          ...
          <h2 className="text-[32px] md:text-[36px] font-[700] text-[#1C1C1C] mb-[12px]">
            Armadale House Cleaning Prices
          </h2>
      ...
      <section className="bg-[#C17B3E] py-[80px] px-[32px] text-center">
        <div className="max-w-[800px] mx-auto">
          ...
          <h2 className="text-[36px] md:text-[48px] font-[800] text-[#ffffff] leading-[1.1]">
            Book a Cleaner in Armadale
          </h2>
          <p className="text-[16px] text-[rgba(255,255,255,0.75)] max-w-[460px] mx-auto mt-[16px] mb-[8px]">
            Get an instant fixed quote for your Armadale terrace, share house or apartment. Book online in under a minute - 15% off your first clean.
          </p>
