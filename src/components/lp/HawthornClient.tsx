...
const faqData = [
  ...
  },
  {
    ...
    answer: "Yes - our Hawthorn coverage includes East Hawthorn and Hawthorn West, as well as the full Glenferrie Road corridor from North Melbourne through to the Coburg boundary."
  },
  {
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .faq-hawthorn-override .group[open] > summary > div {
      ...
      <section className="bg-[#F5F0E8] min-h-[88vh] relative overflow-hidden flex flex-col justify-center">
        ...
        <div className="relative z-10 w-full max-w-[1200px] mx-auto px-[24px] md:px-[48px] pt-[80px] pb-[60px] flex-grow flex flex-col justify-center">
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-[48px]">
            <div className="text-[12px] text-[#9ca3af]">
              <Breadcrumbs 
                items={[
                  { label: "Home", href: "/" },
                  { label: "House Cleaning Hawthorn", href: "/house-cleaning-hawthorn" },
                ]}
              />
            </div>
            <div className="inline-block bg-[rgba(193,123,62,0.12)] border border-[rgba(193,123,62,0.3)] text-[#C17B3E] text-[11px] font-[600] tracking-[0.12em] uppercase rounded-[99px] px-[16px] py-[6px]">
              ● Glenferrie Road · Hawthorn · Inner North
            </div>
          </div>
          ...
          {/* Row 2 — The Headline */}
          <h1 className="hawthorn-word text-[clamp(64px,13vw,172px)] font-[900] text-[#1C1C1C] leading-[0.9] tracking-[-0.04em] block w-full text-left">
            <span>HAWTHORN</span>
          </h1>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start mt-[24px] gap-[32px]">
            <div className="max-w-[480px]">
              <p className="text-[16px] text-[#6b7280] leading-[1.7]">
                Glenferrie Road terraces. Share houses.<br />
      ...
      {/* SECTION 8 — FAQ */}
      <section className="bg-[#F5F0E8] py-[80px] faq-hawthorn-override">
